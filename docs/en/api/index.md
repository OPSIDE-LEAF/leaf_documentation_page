...
| [Authentication](/en/api/authentication) | 1.0.0 | provides Actions and optional adapters for authentication |
...
| [Payment modules](/en/api/payments) | Stripe 1.0.0 · Mercado Pago 1.0.0 | implement a Workflow checkout for each provider |
