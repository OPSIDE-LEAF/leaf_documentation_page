...
hero:
  ...
  image:
    ...
    alt: Leaf
  tagline: Modular ecosystem for cross-platform mobile development. Reusable modules that assemble into Android and iOS apps with native performance, from a single codebase.
  actions:
    - theme: brand
      text: Get Started
      link: /en/guide/
...
features:
  - icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M440-160v-326L336-382l-56-58 200-200 200 200-56 58-104-104v326h-80ZM160-600v-120q0-33 23.5-56.5T240-800h480q33 0 56.5 23.5T800-720v120h-80v-120H240v120h-80Z"/></svg>
    ...
    details: A single codebase for Android and iOS — one team instead of two, half the effort. Launch and validate your product in less time.
  - icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M480-80q-139-35-229.5-159.5T160-516v-244l320-120 320 120v244q0 152-90.5 276.5T480-80Zm0-84q97-30 162-118.5T718-480H480v-315l-240 90v207q0 7 2 18h238v316Z"/></svg>
    title: Native experience, no compromises
    details: Apps indistinguishable from those built with native SDKs. The quality that hybrid layers can't reach, at a cost you can afford.
  - icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M440-183v-274L200-596v274l240 139Zm80 0 240-139v-274L520-457v274Zm-80 92L160-252q-19-11-29.5-29T120-318v-324q0-19 10.5-37t29.5-29l280-161q19-11 40-11t40 11l280 161q19 11 29.5 29t10.5 37v324q0 19-10.5 37T800-252L520-91q-19 11-40 11t-40-11Zm200-528 77-44-237-137-78 44 238 137Zm-160 93 78-45-237-137-78 44 237 138Z"/></svg>
    title: Assemble, don't start from scratch
    details: Login, payments, catalog — tested and versioned modules that plug into your app. Every new project reuses what's already built.
  - icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M120-120v-200h200v200H120Zm260 0v-200h200v200H380Zm260 0v-200h200v200H640ZM120-380v-200h200v200H120Zm260 0v-200h200v200H380Zm260 0v-200h200v200H640ZM120-640v-200h200v200H120Zm260 0v-200h200v200H380Zm260 0v-200h200v200H640Z"/></svg>
    title: Grow at the pace of your business
    details: Add, replace, or retire modules as requirements change, without rewriting the application. Simple maintenance, continuous evolution.
---
...
const hostItems = [
  {
    title: 'Installation',
    description: 'Credentials, repositories, and dependencies for the stable %LEAF_VERSION% train.',
  ...
  {
    title: 'Run an Action',
    description: 'Build a module and run its capability with Leaf.run.',
    ...
    link: '/en/guide/quickstart-action'
  },
  {
    title: 'Open a Feature',
    description: 'Sessions with state, events, and a single terminal result.',
  ...
  },
  {
    ...
    link: '/en/guide/compose-adapter'
  },
  {
    title: 'Integrate modules',
    description: 'Implement gateways, run capabilities, and keep navigation.',
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M440-183v-274L200-596v274l240 139Zm80 0 240-139v-274L520-457v274Zm-80 92L160-252q-19-11-29.5-29T120-318v-324q0-19 10.5-37t29.5-29l280-161q19-11 40-11t40 11l280 161q19 11 29.5 29t10.5 37v324q0 19-10.5 37T800-252L520-91q-19 11-40 11t-40-11Zm200-528 77-44-237-137-78 44 238 137Zm-160 93 78-45-237-137-78 44 237 138Z"/></svg>',
    link: '/en/guide/host-integration'
  },
  {
    title: 'Catalog',
    description: 'Available modules in the ecosystem and their status.',
...
const authorItems = [
  {
    ...
    description: 'Structure, Gradle, ABI validation, and GitHub Packages.',
  ...
  },
  {
    ...
    description: 'Domain models, gateways as ports, and the Module class.',
    ...
    link: '/en/guide/module-implementation'
  },
  {
    title: 'Route + Screen',
    description: 'Module Compose UI: session connector and pure view.',
    ...
    link: '/en/guide/compose-route-screen'
  },
  {
    title: 'Testing',
    description: 'Transitions, gateways, lifecycle, and backpressure in commonTest.',
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm-80-200h160v-80H400v80Zm0-160h160v-280H400v280Z"/></svg>',
    link: '/en/guide/module-testing'
  },
  {
    title: 'Publishing',
    description: 'Clean consumer, full validation, and tag-based publishing.',
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M440-160v-326L336-382l-56-58 200-200 200 200-56 58-104-104v326h-80ZM160-600v-120q0-33 23.5-56.5T240-800h480q33 0 56.5 23.5T800-720v120h-80v-120H240v120h-80Z"/></svg>',
    link: '/en/guide/module-publishing'
  },
  {
...
<CardGrid title="For Hosts — build apps with Leaf" :items="hostItems" />
<CardGrid title="For Authors — build modules for Leaf" :items="authorItems" />
