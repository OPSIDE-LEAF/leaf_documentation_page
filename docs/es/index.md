...
const hostItems = [
  ...
  },
  {
    ...
    description: 'Reducción síncrona y efectos administrados por Core, con opt-in experimental.',
...
const authorItems = [
  ...
  },
  {
    ...
    description: 'Feature estable y ruta Workflow experimental en el módulo del tren 3.0.0.',
